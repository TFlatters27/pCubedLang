...
typedef struct AST_STRUCT {
    ...
    size_t if_body_size;                        // Number of statements in the IF body
    ...
    size_t *else_if_body_sizes;                 // List of sizes for each ELSE IF body
    size_t else_if_count;                       // Number of ELSE IF blocks
    struct AST_STRUCT **else_body;              // List of AST nodes representing the ELSE body
    size_t else_body_size;                      // Number of statements in the ELSE body
} ast_;
